...
import { signupValidations } from "../../../constants/validations"; // validation schema aynı kullanılabilir
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-tr from-blue-500 via-indigo-500 to-indigo-900 py-12 px-4 sm:px-6 lg:px-8">
      <div className="w-full max-w-lg space-y-8">
        <div className="bg-white p-8 rounded-lg shadow-xl border-2 border-indigo-600">
