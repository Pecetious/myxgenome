  ...
  */
  ...
  return (
    ...
    >
      ...
      {data &&
        (data.title === locale.general.title ? (
          <List
            placeholder={undefined}
            onPointerEnterCapture={undefined}
            onPointerLeaveCapture={undefined}
          ...
          >
              ...
              >
                ...
                >
                  {data.section_data.mrna
                    ? locale.general.mrna.true
                    : locale.general.mrna.false}
                </Typography>
              </ListItemSuffix>
            </ListItem>
            ...
            >
              <Typography
                ...
                onPointerLeaveCapture={undefined}
              >
                {locale.general.psychoAnalysisTitle}
              </Typography>
              ...
              >
                ...
                >
                  {data.section_data.psycho_analysis
                    ? locale.general.psychoAnalysis.true
                    : locale.general.psychoAnalysis.false}
                </Typography>
              </ListItemSuffix>
            </ListItem>
            <ListItem
            ...
            >
              <Typography
                ...
                onPointerLeaveCapture={undefined}
              >
                {locale.general.positiveDiseasesTitle}
              </Typography>
              <ListItemSuffix
                placeholder={undefined}
                onPointerEnterCapture={undefined}
        ...
        ) : data.title === locale.heritage.title ? (
          <List
        ...
        ) : data.title === locale.immune.title ? (
          <div>
            <Typography
              variant="paragraph"
              className="w-full md:max-w-[352px] text-sm"
